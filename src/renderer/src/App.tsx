...
type View = 'idle' | 'dashboard' | 'drilldown'
...
export default function App() {
  ...
  useEffect(() => {
    ...
    // native window resize (dashboard/drilldown are the same window width,
    // so navigating between them never resizes anything). While the OS
    // animates that resize, our CSS layout keeps reflowing to match the
    // in-between widths, which can flash an OS/webkit scrollbar for a frame
    // or two — suppressed here for the animation's duration.
  ...
  // scan or quit the app. Quitting is a separate action (right-click →
  // Quit), not what closing the drawer means.
